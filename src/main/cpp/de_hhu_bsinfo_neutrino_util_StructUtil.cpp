...
JNIEXPORT void JNICALL Java_de_hhu_bsinfo_neutrino_util_StructUtil_getDeviceAttributes(JNIEnv *env, jclass clazz, jlong resultHandle) {
...
JNIEXPORT void JNICALL Java_de_hhu_bsinfo_neutrino_util_StructUtil_getPortAttributes (JNIEnv *env, jclass clazz, jlong resultHandle) {
    auto result = castHandle<Result>(resultHandle);
